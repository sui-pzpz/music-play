...
public class ArtistVO {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ArtistVO)) return false;
        final ArtistVO other = (ArtistVO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ArtistVO;
    }
    ...
    public java.lang.String toString() {
        return "ArtistVO(artistId=" + this.getArtistId() + ", name=" + this.getName() + ", role=" + this.getRole() + ")";
    }
}
