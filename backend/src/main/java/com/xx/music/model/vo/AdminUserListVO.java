...
public class AdminUserListVO {
    ...
    @java.lang.SuppressWarnings("all")
    public AdminUserStatsVO getStatistics() {
        return this.statistics;
    }

    @java.lang.SuppressWarnings("all")
    public void setList(final List<AdminUserVO> list) {
        this.list = list;
    }
    ...
    @java.lang.SuppressWarnings("all")
    public void setStatistics(final AdminUserStatsVO statistics) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof AdminUserListVO)) return false;
        final AdminUserListVO other = (AdminUserListVO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof AdminUserListVO;
    }
    ...
    public java.lang.String toString() {
        return "AdminUserListVO(list=" + this.getList() + ", pagination=" + this.getPagination() + ", statistics=" + this.getStatistics() + ")";
    }
}
