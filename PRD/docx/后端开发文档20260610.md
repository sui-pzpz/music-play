...
#### 1.4.1 第三方账号绑定表（t_oauth_account）
...
| sortBy | string | 否 | 排序字段：play_count(默认)/created_at/name |
...
| **super_admin** | admin 所有权限 + 禁用/启用用户、删除用户、新增歌曲、管理其他管理员 |
